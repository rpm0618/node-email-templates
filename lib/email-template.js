    ...
    value: function renderHtml(locals, locale, callback) {
      ...
      return this._init(locale).then(function () {
        ...
        if (_this5.options.juiceOptions) {
          if (_this5.options.juiceOptions.preserveMediaQueries || _this5.options.juiceOptions.preserveFontFaces) {
            debug('Preserving Media Queries And/Or Font Faces');
            _this5.options.juiceOptions.insertPreservedExtraCss = true;
            _this5.options.juiceOptions.extraCss = _this5.options.juiceOptions.extraCss ? _this5.options.juiceOptions.extraCss + '\n' + style : style;
          }
